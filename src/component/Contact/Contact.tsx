      ...
      <div className='mt-8'>
        ...
        <div className='grid grid-cols-5'>
          <div className='col-span-4 relative'>
            <img src={slider} alt='' />
            <p className='absolute font-banmethuot text-white font-bold text-7xl top-20 right-0 translate-x-1/2 w-[535px]'>
          ...
          <div className='col-span-1  mt-6 ml-2'>
            <p className='text-[#c1984f] text-2xl font-century font-extrabold'>Unix Visual</p>
        ...
        <div className='grid grid-cols-4 mt-40 gap-8'>
          {Array(4)
            .fill(0)
            .map((_, index) => (
              <div className='col-span-1 font-copper relative w-full' key={index}>
                <img src={neb} alt='' className='w-full' />
                <div className=' font-copper absolute text-dark top-[305px] w-full -translate-x-1/2 left-1/2 text-center'>
