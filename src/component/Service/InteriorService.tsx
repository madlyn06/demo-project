        ...
        <div className='grid grid-cols-5'>
          ...
          <div className='col-span-4 relative'>
            ...
            <div className='absolute lg:top-20 lg:left-10 md:top-16 md:left-32 left-48 top-20 -translate-x-1/2 w-[535px]'>
              ...
              <p className='text-white font-medium text-base  md:text-lg lg:text-xl pr-72 mt-4'>
            ...
            <div className='hidden md:block md:absolute -bottom-[171px] pb-32 text-[#fff]/40  w-[350px] pr-20 right-12 bg-[#000]/70 pl-2 pt-2'>
