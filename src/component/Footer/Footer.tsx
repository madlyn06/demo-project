        ...
        <div>
          ...
          <div className='flex items-center justify-center'>
            <div
              ...
              className='bg-[#353735] font-copper font-bold text-center text-white text-xl inline-block px-4 md:px-16  md:py-1'
            >
              Mail
            </div>
            {logo.map((item, index) => (
              <div
                ...
                className={`bg-[${item.color}] text-center text-white text-xl inline-block px-4 md:px-16 md:py-1`}
              >
